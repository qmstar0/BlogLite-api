...
func NewTag(pub common.DomainEventPublisher, cmd CreateTagCommand) (Tag, error) {
	if err := pub.Publish(common.TagCreatedEvent, TagCreatedEvent{
		Uid:         cmd.Uid,
		Name:        cmd.Name,
...
func (t *TagImpl) Update(pub common.DomainEventPublisher, cmd UpdateTagCommand) error {
	...
	t.Name = cmd.Name
	return pub.Publish(common.TagUpdatedEvent, TagUpdatedEvent{
		Uid:         cmd.Uid,
		TagId:       t.Id,
		Name:        cmd.Name,
		DisplayName: cmd.DisplayName,
...
func (t *TagImpl) Delete(pub common.DomainEventPublisher, cmd DeleteTagCommand) error {
	...
	return pub.Publish(common.TagDeletedEvent, TagDeletedEvent{
		Uid:   cmd.Uid,
		TagId: t.Id,
	})
}
...
func (t *TagImpl) IncreaseUsed(pub common.DomainEventPublisher, cmd TagIncreaseUseCommand) error {
	t.Num += 1
	return pub.Publish(common.TagIncreasedUsageEvent, TagIncreasedUsageEvent{
		Uid:   cmd.Uid,
		TagId: t.Id,
	})
}
...
func (t *TagImpl) ReduceUsed(pub common.DomainEventPublisher, cmd TagReduceUseCommand) error {
	t.Num -= 1
	return pub.Publish(common.TagReducedUsageEvent, TagReducedUsageEvent{
		Uid:   cmd.Uid,
		TagId: t.Id,
	})
}
